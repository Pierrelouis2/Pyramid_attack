...
class Pyramid(Entity.Entity):
    ...
    def mouvement(self, humain):
        ...
        vect = [humain.object.transformation.translation.x - self.object.transformation.translation.x,
                0, humain.object.transformation.translation.z - self.object.transformation.translation.z]
        norm = math.sqrt(vect[0]*vect[0] + vect[1]*vect[1])
        vect_norm = [float(i)/norm for i in vect]
